...
class Website:
    ...
    def __init__(self, url):
        ...
        try:
            ...
            self.title = "Error fetching webpage"
            self.text = f"Could not fetch{e}"
...
view = gr.Interface(
    ...
    description="Enter a company name and the URL of their landing page to generate a brochure.",
    flagging_mode="never"
)
view.launch()